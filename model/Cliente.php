...
class C_Cliente {
    ...
    function insertarClientePopup() {
        $sql = "INSERT INTO intracliente(codcliente, nombre, abrev, ruc, coduse, validado, codzona) "
                . "values ('$this->codcliente', '$this->nombre', '$this->abrev', '$this->ruc', '$this->coduse', FALSE, '$this->codzona');";
        $result = $this->consultas($sql);
        return $result;
    }
