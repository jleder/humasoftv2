...
//        }
    ...
    function sendmailRegTecnico() {
        ...
        $mail->Body = $this->msjRepTecnicoNuevo();
        $mail->IsHTML(true);
        $mail->AddAddress('gerentetecniconacional@agromicrobiotech.com', "Diego Diaz");
        $mail->AddAddress('gerentetecnicosur@agromicrobiotech.com', "Helio Gonzales");
...
//        }
    ...
    function sendmailRegTecnicotoClientes($correos) {
        ...
        //$mail->AddAddress('gerentetecnicosur@agromicrobiotech.com', "Helio Gonzales");
        //$mail->addCC('reportes@humagroperu.com', "Salvador Giha");
        $mail->addBCC('sistemas@agromicrobiotech.com', "Juan Leder"); //Copia Oculta Juan Leder
    ...
    function sendmailRegComercial() {
        ...
        $mail->IsHTML(true);
        $mail->AddAddress('gerentetecniconacional@agromicrobiotech.com', "Diego Diaz");
        $mail->AddAddress('acomercial@agromicrobiotech.com', "");
        $mail->addCC('reportes@humagroperu.com', "Salvador Giha");
        $mail->addBCC('sistemas@agromicrobiotech.com', "Juan Leder");
