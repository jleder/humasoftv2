...
$templateWord = new TemplateProcessor('PLANTILLA_PROPUESTA.docx');
 
$codprop = $_POST['nombre'];
$nombre = $_POST['nombre'];
    ...
    <body>        
        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <p class="asunto">
                    <strong>Asunto: <span><em> <?php echo $propuesta[6]; ?></em></span></strong>
                </p>                    
            ...
            foreach ($detitem as $item) {
                ...
                if ($plantilla == "HECTAREA PAQ") {
                    ...
                    if ($pup == 't') {
                        ...
                        ?>
                        <div class="row" style="margin-left: -20mm; text-align: center;">
                            <div class="col-lg-7">
                                <table>
                                    <tr>                                        
                                        <?php
