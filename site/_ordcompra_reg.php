                ...
                <div id="form_reg">
                    <div class="panel panel-primary">                        
                        ...
                        <div class="panel-body">                                                            
                            <div class="row">                            
                                <div class="col-lg-3">
                                    Número Orden de Compra<input type = "text" name = "numero_oc" value = "" class="form-control" id="numero_oc" />
                                </div>
                                <div class="col-lg-3">
                                    Fecha<input type = "text" name = "fecha_oc" placeholder="YYYY/MM/DD" value = "" class="form-control" id="cal" />
                                </div>
                            </div>
                            <div class="row">                                                                
                                <div class="col-lg-6">
