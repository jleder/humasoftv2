                                                                            ...
                                                                            <div class="panel-body" style="">
                                                                                ...
                                                                                <div class="row">                                                
                                                                                    ...
                                                                                    <div class="col-lg-2" id="divaddnewcliente">
                                                                                        <br/>
                                                                                        <button type="button" class="btn btn-warning btn-sm" onclick="mostrarNewclienteModal()">Nuevo Cliente</button>
                                                                                    </div>                                                                                    
                                                                                </div>                                                                                        
                                                                                <div class="row">
                                                                                    <div id="divcontacto">                                                
                                                                        ...
                                                                        <div class="panel panel-default">
                                                                            ...
                                                                            <div class="panel-body" style="">                                                                        
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-12">
                                                                                        <input type="checkbox" name="pyk" id="pyk" value="" /> Mostrar Comparativo Economico de P y K.<br/>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-lg-12">
                                                                                        ...
                                                                                        <div class="cuadro_one">
                                                                                            <div class="cuadro_two">
                                                                                                <p style="text-align: center;"><button type="button" onclick="tipoPropuesta('HECTAREA PAQ')" ><img src="img/iconos/prop4.png" height="50px" /></button></p>
                                                                                            </div>
                                                                                            <div style="clear: both"></div>
...
<!--                                                                                        <div class="cuadro_one">
                                                                                ...
                                                                                <div id="divaplicacion" style="display: none;">                                
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div style="text-align: right" class="col-lg-3">
                                                                                            <br/>
                                                                                            <button type="button" class="btn btn-primary" onclick="addbyProducto()" >Insertar o Actualizar Productos</button>
                                                                                        </div>                                                    
                                                                                    </div>                                                
                                                                                </div>                                            
                                                                                <hr/>
                ...
                <script type="text/javascript">
                                                                            ...
                                                                            function mostrarNewclienteModal() {
                                                                                var header = 'Registrar Nuevo Cliente';
                                                                                var form = $(
                                                                                        '<form id="form_ec_reg" name="form_ec_reg" action="#" method="post" enctype="multipart/form-data">' +
                                                                                        '<div class="row">' +
                                                                                        '<div class="col-lg-12">' +
                                                                                        'RUC o DNI<input maxlength="12" type = "text" name = "ruc" value = "" class="form-control" id="ruc" />' +
                                                                                        '</div>' +
                                                                                        '</div>' +
                                                                                        '<div class="row">' +
                                                                                        '<div class="col-lg-12">' +
                                                                                        'Razon Social<input type = "text" name = "razonsocial" value = "" class="form-control" id="razonsocial" />' +
                                                                                        '</div></div>' +
                                                                                        '<div class="row">' +
                                                                                        '<div class="col-lg-6">' +
                                                                                        'Abreviatura<input type = "text" maxlength="6" name = "new_abrev" value = "" class="form-control" id="new_abrev" />' +
                                                                                        '</div>' +
                                                                                        '<div class="col-lg-6">' +
                                                                                        'Zona<select name = "new_zona" class="form-control" id="new_zona">' +
        <?php foreach ($list_zona as $zonas) { ?>
                                                                                    '<option value="' + '<?php echo $zonas["codzona"]; ?>' + '">' + '<?php echo $zonas["zona"]; ?>' + '</option>' +
        <?php } ?>
                                                                                '</select>' +
                                                                                        '</div>' +
                                                                                        '</div>' +
                                                                                        ...
                                                                                        var button = $('<button id="cancelar_cliente" type="cancel" class="btn btn-danger btn-label-left">' +
                                                                                                '<span><i class="fa fa-clock-o txt-danger"></i></span>' +
                                                                                                'Cancelar' +
                                                                                                '</button>' +
                                                                                                '<button type="submit" id="submit_cliente" class="btn btn-success btn-label-left pull-right">' +
                                                                                    ...
                                                                                    if (validarCliente()) {
                                                                                        $.ajax({
                                                                                            ...
                                                                                            success: function (res) {
                                                                                                ...
                                                                                                if (texto === 'OK') {
                                                                                                    alert(texto + ", se registro con éxito.");
                                                                                                    $.alert({
                                                                                                        title: 'Atención!',
                                                                                                        content: 'Ok!'
                                                                                                    });
                                                                                                    ...
                                                                                                    alert(texto + ", no se pudo registrar.");
                                                                                                    $("#result").html("Error, por favor revise los datos ingresados y después dar clic en Guardar");
                                                                                                }
                                                                                            },
                                                                                            ...
                                                                                            data: {accion: 'RegClientePopup', obj: objeto}
                                                                                        });
                                                                                        CloseModalBox();
                                                                                    }
                                                                                });
                                                                            ...
                                                                            function validarCliente() {
                                                                                ...
                                                                                if (ruc === '') {
                                                                                    ...
                                                                                    $.alert({
                                                                                        title: 'Atención!',
                                                                                        content: 'Debe escribir el numero de RUC o DNI!'
                                                                                    });
                                                                                    return false;
                                                                                } else if (nombre === '') {
                                                                                    $("#razonsocial").focus();
                                                                                    $.alert({
                                                                                        title: 'Atención!',
                                                                                        content: 'Debe escribir la razon social!'
                                                                                    });
                                                                                    return false;
                                                                                } else if (abrev === '') {
                                                                                    $("#new_abrev").focus();
                                                                                    $.alert({
                                                                                        title: 'Atención!',
                                                                                        content: 'Debe escribir una abreviatura!'
                                                                                    });
                                                                                    return false;
                                                                                }
                                                                                return true;
