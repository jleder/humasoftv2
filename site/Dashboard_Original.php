                            ...
                            <ul class="nav main-menu">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="ajax-link" href="ajax/charts_xcharts.html">Comerciales</a></li>
                                        <li><a class="ajax-link" href="_actividad.php">Otros</a></li>
                                        <li><a class="ajax-link" href="ajax/charts_fl">Consultas</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="ajax-link" href="site/_charts_xcharts.php">Crear</a></li>
                                        <li><a class="ajax-link" href="ajax/charts_xcharts.html">Ver</a></li>
                                        <li><a class="ajax-link" href="ajax/charts_flot.html">Clientes x Vendedor</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="ajax-link" href="site/_charts_xcharts.php">xCharts Prueba</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">                                
                                        <li><a class="ajax-link" onclick="cargar('#ajax-content', 'site/_actividad_reg2.html')" href="#">Actividad2</a></li>
                                        <li><a class="ajax-link" href="site/_actividad_reg2.html">Site Actividad</a></li>
                                        <li><a class="ajax-link" href="site/_actividad.php">Modulo Actividad</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="ajax-link" href="ajax/actividad_reg2.html">Ajax Actividad</a></li>
                                        <li><a class="ajax-link" href="ajax/forms_elements.html">Elements</a></li>                                
                                        <li><a class="ajax-link" href="ajax/forms_layouts.html">Layouts</a></li>
                                        <li><a class="ajax-link" href="ajax/forms_file_uploader.html">File Uploader</a></li>
                                        <li><a class="ajax-link" href="ajax/_prueba_reg2.html">Prueba</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle">
