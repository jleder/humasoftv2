                                                    ...
                                                    <form id="form_ingreso" name="form_ingreso" action="#" method="post" enctype="multipart/form-data">
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-md-2 control-label">Fecha:</label><div class="col-md-4"><input type="text" class="form-control" name="fecingreso" id="fecingreso" placeholder=""/></div>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-md-2 control-label">Monto:</label><div class="col-md-4"><input type="number" class="form-control" name="monto" id="monto" step="any" /></div>
                                                                </div>
                                                            </div>
