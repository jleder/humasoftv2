                ...
                <script type="text/javascript">
                    ...
                    function mailToDespacho() {
                        ...
                        var form = $(
                                ...
                                '</div>' +
                                '<div class="form-group">' +
                                '<label class="col-md-4 control-label">Para:</label><div class="col-md-8"><input type="email" id="mailpara_desp" class="form-control"  name="mailpara_desp" value="isandoval@humagroperu.com" placeholder="usuario1@ejemplo.com; usuario2@ejemplo.com" /></div>' +
                                '</div>' +
                                '<div class="form-group">' +
