            ...
            <div class="row">
                ...
                <div id="content" class="col-xs-12 col-sm-10">
                    ...
                    <div id="divactividad">
                        ...
                        <div class="row" >
                            <div class="col-lg-2">
                                <a style="font-size: x-small;" href="#" onclick="cargar('#divactividad', '_actividad_reg.php')" class="btn btn-default">
                                                ...
                                                if (count($listactiv) > 0) {
                                                    ...
                                                    foreach ($listactiv as $lista) {
                                                        ...
                                                        <tr style="">    
                                                            ...
                                                            <td width="50">                                                                                                         
                                                                <a href="#" onclick="cargar('#divactividad', 'site/_actividad_edit.php?cod=<?php echo trim($lista['codigo']); ?>')" title="Modificar"><span class="fa fa-edit"></span> </a>                                                                
                                                                <a onClick="return confirmSubmit()" href="javascript:cargar('#divactividad', 'site/_actividad_elim.php?cod=<?php echo trim($lista['codigo']); ?>')" title="Eliminar"><span class="fa fa-trash-o"></span></a>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        $contador++;
