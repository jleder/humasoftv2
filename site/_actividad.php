            ...
            <div class="row">
                ...
                <div id="content" class="col-xs-12 col-sm-10">
                    ...
                    <div id="divactividad">
                        ...
                        <div class="row" >
                            <div class="col-lg-2">
                                <a href="_actividad_reg.php" class="btn btn-default">
                                                    ...
                                                    foreach ($listactiv as $lista) {
                                                        ...
                                                        <tr style="">    
                                                            ...
                                                            <td width="">                                                                                                         
                                                                ...
                                                                <a class="btn btn-danger" onClick="return confirmSubmit()" href="javascript:cargar('#divactividad', '_actividad_elim.php?cod=<?php echo trim($lista['codigo']); ?>&tipo=1')" title="Eliminar"><span class="fa fa-trash-o"></span></a>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        $contador++;
