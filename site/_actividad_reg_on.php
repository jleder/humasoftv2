                            ...
                            <div class="row">
                                <div id="breadcrumb" class="col-md-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <li><a href="_actividad_reg_on.php">Registrar Actividad</a></li>
                                    </ol>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <a class="btn btn-primary" href="_actividad_on.php">Listar Actividades</a>
                                <br/>
                                <!--<div id='calendar'></div>-->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col-sm-12">
                                                                    <?php echo $obj->getTipoActividad_Only('tactividad', '', 'nuevaActividad()', 'nuevaActividad()', ''); ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4" id="divnewactividad" hidden="">
                                                            ...
                                                            <input type="hidden" name="lugar" value="Agro Micro Biotech S.A.C." />
                                                        </div>                                
                                                    </div>                                            
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                    ...
                                    processData: false
                                        ...
                                        .done(function (res) {
                                            ...
                                            if (texto === 'OK') {
                                                ...
                                                location.href = "_actividad_reg_on.php";
                                            } else {
