                ...
                processData: false
                    ...
                    .done(function (res) {
                        ...
                        if (texto === 'OK') {
                            ...
                            $.confirm({
                                title: 'Confirm!',
                                content: 'EN HORA BUENA :)!! Sus datos se han registrado correctamente!',
                                buttons: {
                                    confirm: function () {
                            ...
                            $.alert({
                                title: 'Atención!',
                                content: 'ERROR :(!! No se pudo registrar. Por favor verifique sus datos!'
                            });
                            $("#result").html("Error, por favor revise los datos ingresados");
                        } else if (texto === "CODIGO EXISTE") {
                            $.alert({
                                title: 'Atención!',
                                content: 'ESTE CODIGO YA EXISTE, POR FAVOR CAMBIAR EL CÓDIGO DE PROPUESTA'
                            });
                            $("#result").html("CAMBIAR CÓDIGO DE PROPUESTA");
                            focus("#codprop");
                        }
                    });
        }
...
function crearItemHa() {
    ...
    if (itemdesc === '') {
        ...
        if (fau !== '0') {
            var item = [dcto, pcc, pca, precioAMBT, fau, ha, nitrogeno, plantilla, pud, estado, modificado, incluyeigv, valigv, pup, '', verfc, pyk];
...
function mostrarAsesorExterno() {
    ...
    if (asesor === 'Asesor Externo') {
        ...
        from_2('loadZona', asesor, 'divzona', '_propuestav2_loadall.php');
    }
}
