                            ...
                            foreach ($listaprop as $valor) {
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <a class="btn2 btn-icon" href="_propuestav2_areacomercial.php?codprop=<?php echo trim($valor['codprop']); ?>" title="Área Comercial"><img src="img/iconos/icon-c.png" style="height: 15px; width: 15px;"/></a>
                                        <a class="btn2 btn-icon" href="_propuestav2_detdespacho.php?cod=<?php echo trim($valor['codprop']); ?>" title="Despachos"><img src="img/iconos/icon-d.png" style="height: 15px; width: 15px;"/></a>
