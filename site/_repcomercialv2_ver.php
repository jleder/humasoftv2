...
<?php echo $rptaHuma[2][6]; ?><br/><br/>
            ...
            <p style="text-align: center;">
                <br/><br/><br/>
                <a class="btn btn-primary" href="#" onclick="cargar('#principal', '_repcomercialv2_reg.php')">Crear Visita Comercial</a>             
                <a class="btn btn-danger" href="#" onclick="cargar('#principal', '_repcomercialv2.php')"> Volver </a>            
            </p>
        </div>
