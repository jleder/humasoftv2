                                ...
                                <div class="col-sm-12">
                                    <div class="box">
                                        ...
                                        <div class="box-content">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">                                
                                                    <a href="_repcomercialv2_reg.php" class="btn btn-success">
...
<!--                                                    <a href="_reptecnicov2_re" class="btn btn-primary" onclick="javascript:cargar('#principal', '_reptecnicov2_rep11.php')">                        
