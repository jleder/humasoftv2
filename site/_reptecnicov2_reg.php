    ...
    if ($_SESSION["conectado"] == 'SI') {
                            ...
                            <div class="row">
                                <div id="breadcrumb" class="col-md-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <li><a href="_reptecnicov2_reg.php">Técnicas</a></li>
                                    </ol>
                                </div>
                            </div>
                                    ...
                                    <div class="box">
                                        <div class="box-header">
                                            <div class="box-name">
                                                ...
                                                <span>Registrar Reporte Técnico</span>
                                            </div>
                                            <div class="box-icons">
                                        ...
                                        <div class="box-content">                                                                    
                                            <h5 class="page-header">Llenar Datos</h5>
        ...
        //                }
                ...
                $(document).ready(function () {
                    ...
                    TinyMCEStart('#testrpta1', null);
                    TinyMCEStart('#testrpta2', null);
                    TinyMCEStart('#testrpta3', null);
