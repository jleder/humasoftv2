                                    ...
                                    <div class="box">
                                        <div class="box-header">
                                            <div class="box-name">
                                                ...
                                                <span>Archivos de la Propuesta:</span>
                                            </div>                                            
                                            <div class="box-icons">
                                                    ...
                                                    <div class="panel panel-primary" style="background: whitesmoke; font-size: 0.8em;">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group" id="divmailpara">
                                                                ...
                                                                <div class="col-md-9">                                                                                                                                                               
                                                                    <input type="email" id="mailpara" class="form-control"  name="mailpara" value="<?php echo $correo_vend; ?>" placeholder="usuario1@ejemplo.com; usuario2@ejemplo.com" />
                                                                </div>                           
                                                            </div>
                                                            <div class="form-group" id="divmailpara">
                                                                <label class="col-md-3 control-label">CC:</label>
                                                                <div class="col-md-9">                                                                                                                                                               
                                                                    <input type="email" id="mailpara" class="form-control"  name="mailpara" value="<?php echo $correo_jefe; ?>" placeholder="usuario1@ejemplo.com; usuario2@ejemplo.com" />
                                                                </div>                           
                                                            </div>                                    
                                                            <div class="form-group">
                                                        ...
                                                        <div class="panel-footer text-right">
                                                            <a class="btn btn-warning"><i class="fa fa-mail-forward"></i> Enviar Mail</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
