    ...
    switch ($_POST['accion']) {
        ...
        case 'RegProducto':
            ...
            if ($result) {
                ...
                $msjSucess .= '<strong>OK!</strong> Se registro con éxito.</div>';
                echo $msjSucess;                
            } else {                
                $msjError .= '<strong>ERROR!</strong> No se pudo registrar.</div>';
                echo $msjError;
            }
            break;
        ...
        case 'ActProducto':
            ...
            if ($result) {
                ...
                $msjError .= '<strong>ERROR!</strong> No se pudo actualizar precios.</div>';
                echo $msjError;
            }
            break;
