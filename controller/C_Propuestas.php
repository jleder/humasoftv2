...
//                    echo '</pre>';
                    ...
                    if ($result) {
                        ...
                        for ($i = 0; $i < $cantitem; $i++) {
                            ...
                            $pro->__set('pyk', trim($vectoritem[$i][16]));
...
//                                    echo '</pre>';
                                    ...
                                    foreach ($vectordesp[$i] as $cardesp) {
                                        ...
                                        $congelado = $cardesp['congelado'];

                                        $result100 = $pro->insert_propdb14($codprod, $cantidad1, $cantidad2, $umedida1, $umedida2, $preciou, $preciodcto, $preciototal, $factorb, $ordendesp, $congelado);
                                        if ($result100) {
        ...
        case 'RegDetDespacho':
            ...
            $detd->__set('coddesp', trim(strtoupper($obj['coddesp'])));
            $detd->__set('fecha', trim(strtoupper($obj['fecha'])));
            $detd->__set('estado', trim(strtoupper($obj['estado'])));
            $detd->__set('obs', trim(strtoupper($obj['obs'])));
