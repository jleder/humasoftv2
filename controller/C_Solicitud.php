...
//ENVIAR MAIL                                   
        ...
        $mail->IsHTML(true);
        $mail->AddAddress('elaboraciondepropuestas@agromicrobiotech.com', "Elaboracion de Propuestas");
        $mail->AddAddress('acomercial@agromicrobiotech.com', "Area Comercial");
        $mail->AddAddress('areatecnica@agromicrobiotech.com', "Area Tecnica");
