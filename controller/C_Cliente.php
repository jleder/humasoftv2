...
if (isset($_POST['accion'])) {
    ...
    switch ($_POST['accion']) {
        ...
        case 'RegFundo':
            ...
            case 'RegClientePopup':
                
                $objeto = $_POST['obj'];

                $obj->__set('codcliente', trim(($objeto['codigo'])));
                $obj->__set('nombre', trim(($objeto['nombre'])));
                $obj->__set('ruc', trim(($objeto['codigo'])));
                $obj->__set('abrev', trim(strtoupper($objeto['abrev'])));
                $obj->__set('codzona', trim($objeto['codzona']));
                $obj->__set('coduse', trim(($_SESSION['usuario'])));

                $result = $obj->insertarClientePopup();
                if ($result) {
                    echo 'OK';
                } else {
                    echo 'ERROR';
